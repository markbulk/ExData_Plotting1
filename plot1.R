...
png(filename = "/Volumes/MacStorage/Git/ExData_Plotting1/plot1.png", 
    width = 480, height = 480)

# Plot 1: histogram of Global Active Power; no transformations necessary given data already in kilowatts
hist(dt.days[!is.na(Global_active_power)]$Global_active_power, 
