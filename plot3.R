...
png(filename = "/Volumes/MacStorage/Git/ExData_Plotting1/plot3.png", 
    width = 480, height = 480)

# Plot 3: Time Series of Sub Metering Data
with(dt.days[!is.na(Sub_metering_1)], {
  plot(as.POSIXlt(date_time), Sub_metering_1,
       ylab = "Energy sub metering", 
       xlab = NA, pch = NA)
  lines(as.POSIXlt(date_time), Sub_metering_1,
        col = "black")
  lines(as.POSIXlt(date_time), Sub_metering_2,
        col = "red")
  lines(as.POSIXlt(date_time), Sub_metering_3,
        col = "blue")
